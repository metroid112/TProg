...
public class CtrlListas implements IListas {
	...
	@Override
	public void altaListaDefecto(String nombreListaDefecto) throws Exception { // Itera en todos los usuarios y convoca
	...
	@Override
	public void altaListaParticular(String nombre, String usuario, boolean visibilidad) throws Exception { // busco el
																											// usuario y
																											// le pido a
																											// su canal
																											// que haga
