...
public class CtrlVideos implements IVideos {
  ...
  public void altaVideo(String nick, String nombre, String descripcion, Duration duracion,
      String url, String catString, Date fecha) throws DuplicateClassException {
  ...
  public void altaVideo(String nick, String nombre, String descripcion, Duration duracion,
    ...
    Video video = mUsu.get(nick).getCanal().altaVideo(nombre, descripcion, duracion, url, category,
        fecha, visible);
