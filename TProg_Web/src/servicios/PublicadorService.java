...
public class PublicadorService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://172.16.123.100:10035/publicador?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PublicadorService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://172.16.123.100:10035/publicador?wsdl");
        }
        WSDL_LOCATION = url;
    }
