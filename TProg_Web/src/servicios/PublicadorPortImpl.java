...
@javax.jws.WebService(
                      ...
                      wsdlLocation = "http://172.16.123.100:10035/publicador?wsdl",
...
public class PublicadorPortImpl implements Publicador {
    ...
    public java.lang.String prueba(java.lang.String arg0) {
        ...
        System.out.println(arg0);
        try {
            java.lang.String _return = "_return-253656906";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public servicios.DtPaquete busquedaGeneral(java.lang.String arg0, int arg1) {
        ...
        try {
            ...
            java.lang.String _returnListaAuxVal1 = "_returnListaAuxVal1691298273";
    ...
    public servicios.DtPaquete busquedaCanales(java.lang.String arg0, int arg1) {
        ...
        try {
            ...
            _return.getListaContenido().addAll(_returnListaContenido);
            java.util.List<java.lang.String> _returnListaAux = new java.util.ArrayList<java.lang.String>();
            java.lang.String _returnListaAuxVal1 = "_returnListaAuxVal-987936377";
            _returnListaAux.add(_returnListaAuxVal1);
            _return.getListaAux().addAll(_returnListaAux);
            return _return;
        } catch (java.lang.Exception ex) {
    ...
    public servicios.DtPaquete consultaDeCategoria(java.lang.String arg0) {
        ...
        try {
            ...
            _return.getListaContenido().addAll(_returnListaContenido);
            java.util.List<java.lang.String> _returnListaAux = new java.util.ArrayList<java.lang.String>();
            java.lang.String _returnListaAuxVal1 = "_returnListaAuxVal-1935015678";
            _returnListaAux.add(_returnListaAuxVal1);
            _return.getListaAux().addAll(_returnListaAux);
            return _return;
        } catch (java.lang.Exception ex) {
    ...
    public servicios.DtPaquete busquedaVideo(java.lang.String arg0, int arg1) {
        ...
        try {
            ...
            _return.getListaContenido().addAll(_returnListaContenido);
            java.util.List<java.lang.String> _returnListaAux = new java.util.ArrayList<java.lang.String>();
            java.lang.String _returnListaAuxVal1 = "_returnListaAuxVal1910329153";
            _returnListaAux.add(_returnListaAuxVal1);
            _return.getListaAux().addAll(_returnListaAux);
            return _return;
        } catch (java.lang.Exception ex) {
    ...
    public java.lang.String prueba2() {
        ...
        try {
            java.lang.String _return = "_return450307926";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public servicios.DtPaquete listarCategorias() {
        ...
        try {
            ...
            _return.getListaContenido().addAll(_returnListaContenido);
            java.util.List<java.lang.String> _returnListaAux = new java.util.ArrayList<java.lang.String>();
            java.lang.String _returnListaAuxVal1 = "_returnListaAuxVal-266494862";
            _returnListaAux.add(_returnListaAuxVal1);
            _return.getListaAux().addAll(_returnListaAux);
            return _return;
        } catch (java.lang.Exception ex) {
    ...
    public servicios.DtPaquete busquedaLista(java.lang.String arg0, int arg1) {
        ...
        try {
            ...
            _return.getListaContenido().addAll(_returnListaContenido);
            java.util.List<java.lang.String> _returnListaAux = new java.util.ArrayList<java.lang.String>();
            java.lang.String _returnListaAuxVal1 = "_returnListaAuxVal-847226330";
            _returnListaAux.add(_returnListaAuxVal1);
            _return.getListaAux().addAll(_returnListaAux);
            return _return;
        } catch (java.lang.Exception ex) {
