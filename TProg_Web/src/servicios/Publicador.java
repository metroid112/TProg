...
public interface Publicador {
    ...
    @WebMethod
    @Action(input = "http://servicios/Publicador/modificarUsuarioRequest", output = "http://servicios/Publicador/modificarUsuarioResponse", fault = {@FaultAction(className = DuplicateClassException_Exception.class, value = "http://servicios/Publicador/modificarUsuario/Fault/DuplicateClassException")})
