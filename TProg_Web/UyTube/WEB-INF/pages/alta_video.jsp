	...
	<div class="page">
		...
		<%} %>
			<form action="AltaVideo" method="POST" id="formAltaVideo">
				...
				<br>
				Duración (H M S): <br> <input type="number" name="duracionH" min="0" required><input type="number" name="duracionM" min="0" required><input type="number" name="duracionS" min="0" required>*
				<br>
