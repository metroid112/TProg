...
<body>
	<div class="page">
		...
		<div class="contenido">
				...
				<br>
				Confirmar contraseÃ±a: <input type="password" name="passConfirm" required>*
				<br>
				...
				<br>
				Visibilidad: <input type="radio" name="visibilidad" checked>Privado  <input type="radio" name="visibilidad">PÃºblico
				<br>
				Categoría:
