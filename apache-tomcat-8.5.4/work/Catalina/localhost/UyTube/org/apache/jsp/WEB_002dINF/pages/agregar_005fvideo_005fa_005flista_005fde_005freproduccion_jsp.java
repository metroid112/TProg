 ...
 * Generated at: 2018-10-15 14:12:14 UTC
...
public final class agregar_005fvideo_005fa_005flista_005fde_005freproduccion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\t<title>UyTube - Agregar video a lista</title>\n");
      out.write("</head>\n");
      out.write("<body>\n");
 ...
 if (request.getAttribute("ERROR") != null) { 
      ...
      out.write("\n");
      out.write("\t\t\t<form action=\"AgregarVideoALista\" method=\"POST\">\n");
      out.write("\t\t\t\t<h1>Videos</h1>\n");
      out.write("\t\t\t\t<br>\n");
      out.write("\t\t\t\t<select required name=\"video\">\n");
      out.write("\t\t\t\t\t<option value=\"\" disabled selected hidden>Seleccione un video</option>\n");
      out.write("\t\t\t\t\t");
 for (DtVideo video : (DtVideo[]) request.getAttribute("LISTA_DE_VIDEOS")) { 
      ...
      out.write("\t\t\t\t<br>\n");
      out.write("\t\t\t\t<select required name=\"lista\">\n");
      out.write("\t\t\t\t\t<option value=\"\" disabled selected hidden>Seleccione una lista</option>\n");
      out.write("\t\t\t\t\t");
 for (String listasPorDefecto : (String[]) request.getAttribute("LISTAS_POR_DEFECTO")) { 
      out.write("\n");
      out.write("\t\t\t\t\t\t<option value=\"D");
      out.print( listasPorDefecto );
      out.write('"');
      out.write(' ');
      out.write('>');
      out.print( listasPorDefecto + " - Defecto" );
      out.write("</option>\n");
      out.write("\t\t\t\t\t");
 } 
      out.write("\n");
 ...
 for (String listasParticulares : (String[]) request.getAttribute("LISTAS_PARTICULARES")) { 
      ...
      out.print( listasParticulares );
      out.write('"');
      out.write('>');
      out.print( listasParticulares + " - Particular" );
      out.write("</option>\n");
      out.write("\t\t\t\t\t");
 } 
      out.write("\n");
      ...
      out.write("\t\t\t\t<br>\n");
      out.write("\t\t\t\t<br>\n");
      out.write("\t\t\t\t<input type=\"hidden\" name=\"agregarVideo\" value=\"\">\n");
