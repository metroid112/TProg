...
public class CtrlVideosTest {
  ...
  public void testModificarVideo() throws InvalidDataException, DuplicateClassException {
    interfazVideos.modificarVideo("tabarec", "Locura celeste", "test", "testDescripcion",
        "https://youtu.be/zBR2pnASlQE", "Noticias", Duration.parse("PT1H"),
        true, new Date());
  ...
  public void testAltaVideo() throws DuplicateClassException, NotFoundException {
    ...
    interfazVideos.altaVideo("hectorg", "TestVideo", "testDescripcion", Duration.parse("PT1H"),
        "https://youtu.be/GzOJSk4urlM", "Noticias",
        new Date(), true);
  ...
  public void testDtVideo() throws NotFoundException {
    ...
    int idVideo = vid.idVideo;
    vid = interfazVideos.getDtVideo(idVideo);
